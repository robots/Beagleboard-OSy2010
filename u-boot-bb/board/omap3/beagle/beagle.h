...
#define MUX_BEAGLE() \
 ...
 /*Wireless LAN */\
 MUX_VAL(CP(MMC2_CLK),		(IEN  | PTU | DIS | M1)) /*MD - McSPI3_CLK*/\
 MUX_VAL(CP(MMC2_CMD),		(IEN  | PTU | DIS | M1)) /*MD - McSPI3_SIMO*/\
 MUX_VAL(CP(MMC2_DAT0),		(IEN  | PTU | EN  | M1)) /*MD - McSPI3_SOMI*/\
 MUX_VAL(CP(MMC2_DAT1),		(IEN  | PTU | EN  | M4)) /*MD - GPIO_133*/\
 MUX_VAL(CP(MMC2_DAT2),		(IEN  | PTU | DIS | M1)) /*MD - McSPI3_CS1*/\
 MUX_VAL(CP(MMC2_DAT3),		(IEN  | PTU | DIS | M1)) /*MD - McSPI3_CS0*/\
 MUX_VAL(CP(MMC2_DAT4),		(IEN  | PTU | EN  | M4)) /*MD - GPIO_136*/\
 MUX_VAL(CP(MMC2_DAT5),		(IEN  | PTU | EN  | M4)) /*MD - GPIO_137*/\
 ...
 MUX_VAL(CP(MCBSP3_DR),		(IDIS | PTD | DIS | M4)) /*MD - GPIO_141*/\
 ...
 MUX_VAL(CP(MCBSP1_FSX),	(IEN  | PTD | DIS | M1)) /*MCSPI4_CS0*/\
